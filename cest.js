...
loadAndStyleGeoJson(oceansGeojsonUrl, Cesium.Color.REDS.withAlpha(1), Cesium.Color.WHITE, oceansHeight, false, false, true); // For oceans, set isOceanLayer to true
