...
viewer.dataSources.add(Cesium.GeoJsonDataSource.load(geoJsonUrl, {
    stroke: Cesium.Color.fromCssColorString('#4682B4').withAlpha(0.9),
...
viewer.dataSources.add(Cesium.GeoJsonDataSource.load(geoJsonUrl, {
    stroke: new Cesium.Color(1.0, 1.0, 1.0, 0.9), // White color with 50% transparency    
...
viewer.dataSources.add(Cesium.GeoJsonDataSource.load(geoJsonUrl, {
    stroke: new Cesium.Color(1, 1, 1, 0.1),   
    fill: new Cesium.Color(1, 1, 1, 0.9), // Fully transparent fill color
    strokeWidth: 0.1
}));
