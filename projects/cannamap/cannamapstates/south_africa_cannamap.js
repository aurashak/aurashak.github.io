...
// Fetch GeoJSON data for South Africa and add to the map
fetch('https://aurashak.github.io/projects/cannamap/maps/statesandprovinces.geojson')
    .then(response => response.json())
    .then(data => {
        // Filter GeoJSON features to only include South Africa
        var filteredData = data.features.filter(feature => feature.properties.geonunit === "South Africa");
