// SurveyJS code
var surveyJSON = {
    title: "NY Infrastructure Map Survey",
    pages: [
        {
            questions: [
                {
...
Survey.Survey(document.getElementById("surveyContainer"), {
    ...
    onComplete: function (survey) {
        // Send survey data to the backend (replace with your Google Cloud Function URL)
        fetch('https://YOUR-CLOUD-FUNCTION-URL/submit-survey', {
            method: 'POST',
            headers: {
