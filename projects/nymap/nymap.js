...
var evacuationzonesLayer = L.geoJSON.ajax('https://aurashak.github.io/geojson/nyc/evacuationzones.geojson', {
    ...
    onEachFeature: function (feature, layer) {
        // Corrected: Use feature.properties instead of feature.content
        layer.bindPopup(createEvacuationZonsPopupContent(feature.properties));
    }
});
...
var populationLayer = L.geoJSON.ajax('https://aurashak.github.io/geojson/nyc/cttotalpop2020.geojson', {
    ...
    onEachFeature: function (feature, layer) {
        var censusTract = feature.properties.ct2010;
...
function getMajorityRacialCategory(properties) {
    var races = [
        'racepop4_Hispanic or Latino',
        'racepop4_White alone',
        'racepop4_Black or African American alone',
        'racepop4_American Indian and Alaskan Native alone',
        'racepop4_Asian alone',
        'racepop4_Hawaiian and Other Pacific Islander alone',
        'Other'
    ];
...
var racialPopulationLayer = L.geoJSON.ajax('https://aurashak.github.io/geojson/nyc/ctracepop2020.geojson', {
    style: function (feature) {
        ...
        var raceColors = {
            'racepop4_Hispanic or Latino': '#ff0000', // Red
            'racepop4_White alone': '#ffffff', // White
            'racepop4_Black or African American alone': '#000000', // Black
            'racepop4_American Indian and Alaskan Native alone': '#964B00', // Brown
            'racepop4_Asian alone': '#00ff00', // Green
            'racepop4_Hawaiian and Other Pacific Islander alone': '#0000ff', // Blue
            'Other': '#808080' // Gray
        };

        return {
            fillColor: raceColors[majorityRace],
            color: 'black',
            weight: 0.5,
            opacity: 0.7,
            fillOpacity: 0.7
...
// Add an event listener to the racial population checkbox
racialPopulationCheckbox.addEventListener('change', function () {
    if (racialPopulationCheckbox.checked) {
        map.addLayer(racialPopulationLayer);
    } else {
...
document.getElementById('nyairports').addEventListener('change', function () {
    if (document.getElementById('nyairports').checked) {
        // If the switch is checked, add the layer
        nyairportsLayer.addTo(map);
    } else {
        // If the switch is unchecked, remove the layer
        map.removeLayer(nyairportsLayer);
    }
});
...
setLegendSymbol('racePopulation', {
    ...
    'White': '#ffffff',
    'Black or African American': '#000000',
    'American Indian and Alaskan Native': '#964B00',
    'Asian': '#00ff00',
    'Hawaiin and Other Pacific Islander': '#0000ff',
...
setLegendSymbol('powerplants', {
    ...
    'Combination': 'black'
}, 'circle'); // Add 'Combination' as the label for the default color
