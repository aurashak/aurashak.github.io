...
// Define URLs to the GeoJSON data
var oceansGeojsonUrl = 'https://aurashak.github.io/geojson/oceans.geojson'; // URL to the oceans GeoJSON
...
var lakesGeojsonUrl = 'https://aurashak.github.io/geojson/rivers.geojson';
var lakesGeojsonUrl = 'https://aurashak.github.io/geojson/regions.geojson';


// You can add more URLs for other layers here
...
loadAndStyleGeoJson(lakesGeojsonUrl, Cesium.Color.RED.withAlpha(1.0), Cesium.Color.WHITE);
loadAndStyleGeoJson(riversGeojsonUrl, Cesium.Color.RED.withAlpha(1.0), Cesium.Color.WHITE);
loadAndStyleGeoJson(regionsGeojsonUrl, Cesium.Color.RED.withAlpha(1.0), Cesium.Color.WHITE);
